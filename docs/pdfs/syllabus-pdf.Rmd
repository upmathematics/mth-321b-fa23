...
header-includes: |
  \usepackage{fancyhdr}
  \pagestyle{fancy}
  \fancyhead[RO,R]{MTH 321B ODE - Syllabus}
  \fancyfoot[CO,C]{}
  \fancyfoot[R]{\thepage}
  \usepackage{float}
output:
...
Learning mathematics takes hard work, thinking what you have learned, making changes to your understanding. Students will be assessed on their proficiency in mathematics, and they will have opportunities to demonstrate their proficiency, revise their work and reflect on their learning.
...
There will be a worksheet for each non-exam week. The purpose of the worksheets is for in-class group work and activities. The group must submit their completed worksheet by end-of-class or end-of-day. Worksheets are graded mostly on completion, and partially on correctness. Your name must exist in your group worksheet submission.

### Homeworks

Homework is assigned every week and due every Friday by end-of-day. You must do and submit your homework individually. Homework is graded mostly on correctness and completion.
...
Exam retake procedure are similar to the original exam. There are three possible kinds of exam retakes you can choose depending on your exam grade.
  ...
  * *Both:* The written part is your revised exam and the oral part is explaining your revisions.
