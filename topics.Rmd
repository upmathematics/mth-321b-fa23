...
| **13** | Tu 11/21 | Graphical Approaches of Higher-Order ODEs | Converting $n$th-Order ODE into 1st-Order System of ODEs | Assigned: Homework 6 | - |
|  | Th 11/23 | _Thanksgiving Vacation_ | - | - | - |
| **14** | Tu 11/28 | Review | Exam 3 Examples | - | Exam 3 Guide  |
|  | Th 11/30 | **Exam 3** | - | - | - |
| **15** | Tu 12/5 | Non-Linear ODEs and Systems | Exploring Non-Linearity | All Revisions & Retakes Due | - |
